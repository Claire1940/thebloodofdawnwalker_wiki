...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - The Blood of Dawnwalker Wiki',
    description: 'Copyright and intellectual property information for The Blood of Dawnwalker Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - The Blood of Dawnwalker Wiki',
      description: 'Copyright and intellectual property information for The Blood of Dawnwalker Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 The Blood of Dawnwalker Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of The Blood of Dawnwalker Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              The Blood of Dawnwalker Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Rebel Wolves</strong> - Developer of The Blood of Dawnwalker</li>
              <li><strong>Bandai Namco Entertainment</strong> - Publisher of The Blood of Dawnwalker</li>
              <li><strong>Steam</strong> - Third-party PC storefront for the game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>The Blood of Dawnwalker</strong> - Trademark of its respective owners</li>
              <li><strong>Bandai Namco Entertainment</strong> - Trademark of Bandai Namco Entertainment Inc.</li>
              <li><strong>Rebel Wolves</strong> - Trademark of its respective owners</li>
              <li><strong>STEAM</strong> - Trademark of Valve Corporation</li>
              <li><strong>The Blood of Dawnwalker Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with The Blood of Dawnwalker Wiki.
            </p>
            ...
            <p>
              ...
              The Blood of Dawnwalker Wiki<br />
              Email: <a href="mailto:dmca@thebloodofdawnwalker.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@thebloodofdawnwalker.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "The Blood of Dawnwalker Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: The Blood of Dawnwalker Wiki (thebloodofdawnwalker.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@thebloodofdawnwalker.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@thebloodofdawnwalker.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@thebloodofdawnwalker.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@thebloodofdawnwalker.wiki</a>
            </p>
            <p>
