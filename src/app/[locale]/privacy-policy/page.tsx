...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - The Blood of Dawnwalker Wiki',
    description: 'The Blood of Dawnwalker Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our dark fantasy action RPG resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              The Blood of Dawnwalker Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              The Blood of Dawnwalker Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Rebel Wolves and Bandai Namco Entertainment. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@thebloodofdawnwalker.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@thebloodofdawnwalker.wiki</a>
            </p>
            <p>
