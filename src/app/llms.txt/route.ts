...
export async function GET() {
  const baseUrl = (process.env.NEXT_PUBLIC_SITE_URL || 'https://thebloodofdawnwalker.wiki').replace(/\/$/, '')
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'The Blood of Dawnwalker'
